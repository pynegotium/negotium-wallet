...
$(document).ready(function() {
  ...
  $.reject({  
    ...
    header: 'Your browser is not supported with Negotium Wallet',
    paragraph1: "Negotium Wallet's security features require a newer browser than what you are using. We recommend Chrome for the best user experience."
